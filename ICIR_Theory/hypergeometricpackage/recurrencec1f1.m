function [r]=recurrencec1f1(a,b,z,n,k)
...
% Computes the minimal solution of the recurrence relation (3.33),        %
...
% Output: r=Computed value of 1F1(a+k;b+k;z)                              %
%-------------------------------------------------------------------------%
