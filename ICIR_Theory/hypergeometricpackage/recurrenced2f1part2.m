function [r]=recurrenced2f1part2(a,b,c,z,n,k)
...
% Output: r=Computed value of 2F1(1-a,1-b;1-a-b+c+k;1-z)                  %
%-------------------------------------------------------------------------%
...
f1=gamma(c)/gamma(1-a-b+c)*hypergeom([1-a,1-b],1-a-b+c,1-z);
v(end)=0;v(end-1)=1;
...
for i3=1:k+1
    f(i3)=f1/v(1)*v(i3)/((z-1)/z)^(i3-1)/gamma(c+i3-1)*gamma(-a-b+c+i3);
end
