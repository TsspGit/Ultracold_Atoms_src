function [h]=pade2f1(ar,ai,br,bi,cr,ci,zr,zi,p,q)
...
% a,b and variable z using Pade approximants as detailed in Appendix H.3. %
...
% Set up vector expressing first p+q+1 terms in Taylor series (4.1)
A=zeros(p+q+1,1);
A(1)=1;
for j1=2:p+q+1
    A(j1)=(a+j1-2)*(b+j1-2)/(c+j1-2)/(j1-1)*A(j1-1);
end
