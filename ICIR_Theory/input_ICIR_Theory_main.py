...
Erm    = 8.250619644642796e-11                           # (0,0,0) relative motion energy (Config False)
ECM    = 8.250619644642796e-11                           # (0,0,0) center of mass motion energy (Config False)
En_CM  = 3.178263170129677e-10                           # (0,n,0) and (n,0.0) free energies if model=Numerical DVR
Config = True                                             # Use config energies with model=Numerical
Econfig= 1.6156984481567438e-10                           # DVR input if model=numerical
