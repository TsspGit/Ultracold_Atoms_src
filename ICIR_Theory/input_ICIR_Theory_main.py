...
Erm    = 7.602916680169239e-11                           # (0,0,0) relative motion energy (Config False)
ECM    = 7.602916680169239e-11                           # (0,0,0) center of mass motion energy (Config False)
En_CM  = 2.5891550813915446e-10                           # (0,n,0) and (n,0.0) free energies if model=Numerical DVR
Config = True                                             # Use config energies with model=Numerical
Econfig= 1.4860099719625686e-10                           # DVR input if model=numerical
E_ICIR = 3.6304285051692675                               # Energies Resonances
