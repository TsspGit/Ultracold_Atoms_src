...
#
   ...
   set LOG         = $MAINDIR/log
   set SCR         = ~/TwoAtInOL/d2h/scratch/scr/
...
#
   ...
   set PRECISION    = $5 # precision
                          #  Q - quadrupole
                          #  D - double
   set BITMODE      = $6 # ifort32 or ifort64
   set COMPOPTIO    = $7 # compilation options
   ...
   set COPYCLEAN    = $8 # delete outputs of all previous calculations or copy current outputs into all claster machines
   set LEV	        = $9 # set CI level to plot directly; Set to -1 if to be neglected
#
...
#   setenv nameCOEF      $INPUTORBIT/trap/generic_trap_coeff/$FILECOEF.coeff
